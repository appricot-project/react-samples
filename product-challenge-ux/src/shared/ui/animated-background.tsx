...
export function AnimatedBackground() {
  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
      ...
      <div className="absolute top-[5%] left-[10%] animate-float-1">
        <div
          ...
          style={{
            ...
            transform: `translate(${orbOffset(mousePosition.x, 120)}px, ${orbOffset(
              mousePosition.y,
              100
            )}px)`,
      ...
      {/* Purple/fuchsia orb */}
      <div className="absolute top-[40%] right-[5%] animate-float-2">
        <div
          ...
          style={{
            ...
            transform: `translate(${orbOffset(mousePosition.x, -100)}px, ${orbOffset(
              mousePosition.y,
              -80
            )}px)`,
      ...
      {/* Indigo-violet orb */}
      <div className="absolute bottom-[0%] left-[25%] animate-float-3">
        <div
          ...
          style={{
            ...
            transform: `translate(${orbOffset(mousePosition.x, 80)}px, ${orbOffset(
              mousePosition.y,
              -90
            )}px)`,
      ...
      {/* Light violet orb */}
      <div className="absolute top-[55%] left-[0%] animate-float-4">
        <div
          ...
          style={{
            ...
            transform: `translate(${orbOffset(mousePosition.x, 60)}px, ${orbOffset(
              mousePosition.y,
              70
            )}px)`,
      ...
      {/* Soft lavender orb */}
      <div className="absolute top-[20%] right-[20%] animate-float-5">
        <div
          ...
          style={{
            ...
            transform: `translate(${orbOffset(mousePosition.x, -70)}px, ${orbOffset(
              mousePosition.y,
              50
            )}px)`,
